...
[![x-cmd/install — himalaya Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/himalaya.svg?lang=zh)](https://x-cmd.com/install/himalaya)
...
合计: **23,605** 行代码（覆盖前 5 种语言、共 **343** 个文件）。
...
- **上游仓库**: <https://github.com/pimalaya/himalaya>
...
- **Star**: 7,307 · **Fork**: 238 · **开放 issue**: 525 · **贡献者**: 62

## 累计统计

- **发布数**: 45 · **已合并 PR**: 124 · **开放 PR**: 5 · **已关闭 issue**: 510 · **开放 issue**: 15 · **提交数**: 1179

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 0 | 1 | 5 | 3 | 10 | 4 |
| last60d | 2026-07-25 | 2 | 3 | 5 | 24 | 10 | 43 |
| 90d | 2026-06-25 | 2 | 3 | 5 | 29 | 10 | 77 |
| last180d | 2026-03-27 | 2 | 9 | 5 | 62 | 11 | 163 |
| 360d | 2025-09-28 | 3 | 15 | 5 | 117 | 12 | 244 |
| last720d | 2024-10-03 | 5 | 25 | 5 | 192 | 14 | 441 |
...
himalaya 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `himalaya` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/himalaya.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T05:25:52Z._
